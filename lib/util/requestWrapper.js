...
class RequestUtil {
    constructor(key, secret, baseUrl, options = {}, requestOptions = {}) {
        ...
        this.globalRequestOptions = Object.assign({ 
            ...
            timeout: this.options.recv_window, headers: {} }, requestOptions);
    ...
    setRequestOptions(optionKey, optionValue) {
    ...
    _call(method, endpoint, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return axios_1.default({ httpAgent, httpsAgent }).then(response => {
